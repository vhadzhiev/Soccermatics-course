...
match_ids = df_match.loc[(df_match["home_team_name"] == team) | (df_match["away_team_name"] == team)][
    "match_id"].tolist()
...
for idx in match_ids:
    ...
    for period in [1, 2]:
        # keep only accurate passes by Portugal that were not set pieces in this period
        ...
        # keep only Shots by Portugal in this period
